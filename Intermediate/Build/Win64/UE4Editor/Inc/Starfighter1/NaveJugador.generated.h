...
#ifdef STARFIGHTER1_NaveJugador_generated_h
...
template<> STARFIGHTER1_API UClass* StaticClass<class ANaveJugador>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Starfighter1_Source_Starfighter1_NaveJugador_h
